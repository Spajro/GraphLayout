...
pub fn add(position: Position, vector: StandardVector) -> Position {
    Position {
...
pub fn join(vector1: StandardVector, vector2: StandardVector) -> StandardVector {
    StandardVector {
...
mod tests {
    use crate::math2d::{StandardVector, scale_standard_vector};
